...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      {stats?.comparisons && (
        <div>
          <h2 className="text-xl font-semibold text-gray-700 mb-4">Performance Trends</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {statCards.length > 4 && (
            <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200 hover:shadow-lg transition-shadow">
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  <p className="text-sm text-gray-600 mb-1">{statCards[4].title}</p>
                  <p className="text-2xl font-bold text-gray-800">{statCards[4].value}</p>
                </div>
                <div className={`${statCards[4].color} p-3 rounded-lg`}>
                  {(() => {
                    const Icon = statCards[4].icon;
      ...
      <div>
        <h2 className="text-xl font-semibold text-gray-700 mb-4">Analytics & Insights</h2>
      ...
      {/* Section 5: Admin Management (if admin) */}
      {user?.role === 'admin' && (
        <div>
          <h2 className="text-xl font-semibold text-gray-700 mb-4">Management Overview</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200 hover:shadow-lg transition-shadow">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600 mb-1">Total Salary This Month</p>
                  <p className="text-2xl font-bold text-gray-800">{formatCurrency(stats?.totalSalaryThisMonth || 0)}</p>
                </div>
                <div className="bg-green-500 p-3 rounded-lg">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200 hover:shadow-lg transition-shadow">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600 mb-1">Pending Salaries</p>
                  <p className="text-2xl font-bold text-orange-600">{formatCurrency(stats?.pendingSalaries || 0)}</p>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200 hover:shadow-lg transition-shadow">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-800">{stats?.totalSuppliers || 0}</p>
                </div>
                <div className="bg-blue-500 p-3 rounded-lg">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200 hover:shadow-lg transition-shadow">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600 mb-1">Supplier Balance</p>
                  <p className="text-2xl font-bold text-gray-800">{formatCurrency(stats?.supplierBalance || 0)}</p>
                </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200 hover:shadow-lg transition-shadow">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-yellow-600">{stats?.pendingPurchaseOrders || 0}</p>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200 hover:shadow-lg transition-shadow">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600 mb-1">Expenses This Month</p>
                  <p className="text-2xl font-bold text-red-600">{formatCurrency(stats?.totalExpensesThisMonth || 0)}</p>
                </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200 hover:shadow-lg transition-shadow">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-green-600">{formatCurrency(stats?.cashBalance || 0)}</p>
                </div>
                <div className="bg-green-500 p-3 rounded-lg">
      ...
      <div>
        <h2 className="text-xl font-semibold text-gray-700 mb-4">Activity & Alerts</h2>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Recent Sales */}
          <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
